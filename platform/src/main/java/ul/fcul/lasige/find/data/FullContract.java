...
public class FullContract {
    ...
    /**
     * Constants for the Apps table of the FIND data provider. It is used to store api tokens
     */
    public static final class Apps implements BaseColumns {
        ...
        /**
         * The time this app has been added to the FIND platform.<br>
         * Type: INTEGER
         */
    ...
    /**
     * Constants for the ClientImplementations table of the FIND data provider. This table is a mapping
     * between protocol identifiers and apps implementing that protocol.
     */
    public static final class ClientImplementations implements BaseColumns {
        /**
         * The name of the protocol implementors table in the database.
         */
        public static final String TABLE_NAME = "ClientImplementations";
         ...
         */
        public static final String VIEW_NAME_FULL_DETAILS = "Client_Implementations_View";
         ...
         * The base content URI for this table.
         */
        public static final Uri URI_ALL = Uri.withAppendedPath(URI_BASE, "clientimplementations");

        /**
         * The MIME type for a directory of implementations.
         */
        public static final String CONTENT_DIR_TYPE =
                ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd." + AUTHORITY + ".clientimplementations";

        /**
         * The MIME type for a single implementation.
         */
        public static final String CONTENT_ITEM_TYPE =
                ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd." + AUTHORITY + ".clientimplementations";
    }
    ...
    /**
     * Constants for the Identity table of the FIND data provider. This is used to store encryption keys
     */
    ...
    public static final class Neighbors implements BaseColumns {
        ...
        public static final String SQL_CREATE_TABLE =
                "create table " + TABLE_NAME + " ("
                        ...
                        + COLUMN_TIME_LASTPACKET + " integer not null default 0, "
                        + COLUMN_NETWORK + " text, "
                        + COLUMN_IP4 + " blob, "
                        + COLUMN_IP6 + " blob, "
         ...
         */
        public static final String WHERE_CLAUSE_TIME_SEEN = COLUMN_TIME_LASTSEEN + " >= %d";

        /**
         * The WHERE clause used when retrieving neighbors based on last sent packet timestamp.
         */
        public static final String WHERE_CLAUSE_TIME_PACKET = COLUMN_TIME_LASTPACKET + " >= %d";
    ...
    public static final class RemoteProtocols implements BaseColumns {
        ...
        private static final String COMMON_JOIN_COLUMNS =
                "RP." + COLUMN_PROTOCOL_HASH + ", "
                        ...
                        + "N." + Neighbors.COLUMN_TIME_LASTPACKET;
    }
    ...
    public static final class NeighborProtocols {
         ...
         * The WHERE clause used when retrieving current or recent neighbors.
         */
        public static final String WHERE_CLAUSE_TIME_SEEN = Neighbors.COLUMN_TIME_LASTSEEN + " >= %d";

        /**
         * The WHERE clause used when retrieving last sent packet to neighbors.
         */
        public static final String WHERE_CLAUSE_TIME_PACKET = Neighbors.COLUMN_TIME_LASTPACKET + " >= %d";
    ...
    public static final class ProtocolNeighbors {
         ...
         * timestamp.
         */
        public static final String WHERE_CLAUSE_PROTOCOL_AND_TIME_SEEN =
                DbHelper.buildBinaryWhere(RemoteProtocols.COLUMN_PROTOCOL_HASH)
                        + " and " + Neighbors.COLUMN_TIME_LASTSEEN + " >= %s";

        /**
         * The WHERE clause to use when filtering for a protocol hash and the neighbor's last sent
         * packet timestamp.
         */
        public static final String WHERE_CLAUSE_PROTOCOL_AND_TIME_PACKET =
                DbHelper.buildBinaryWhere(RemoteProtocols.COLUMN_PROTOCOL_HASH)
                        + " and " + Neighbors.COLUMN_TIME_LASTPACKET + " >= %s";
