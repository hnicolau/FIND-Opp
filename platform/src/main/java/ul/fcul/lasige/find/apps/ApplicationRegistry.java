...
public class ApplicationRegistry {
    private static final String TAG = ApplicationRegistry.class.getSimpleName();
    ...
    public static synchronized ApplicationRegistry getInstance(Context context) {
        if (sInstance == null) { sInstance = new ApplicationRegistry(context); }
        return sInstance;
    }
    ...
    public String registerApplication(String packageName) {
        Log.d(TAG, "Entered registerApplication()");
