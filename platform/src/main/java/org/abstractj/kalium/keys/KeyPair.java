...
public class KeyPair {
    ...
    public KeyPair() {
        this.secretKey = Util.zeros(SodiumConstants.SECRETKEY_BYTES);
        this.publicKey = Util.zeros(SodiumConstants.PUBLICKEY_BYTES);
        Sodium.crypto_box_curve25519xsalsa20poly1305_keypair(publicKey, secretKey);
    }

    public KeyPair(byte[] secretKey) {
        this.secretKey = secretKey;
        Util.checkLength(this.secretKey, SodiumConstants.SECRETKEY_BYTES);
